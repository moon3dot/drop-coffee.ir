...
class testimonial_carousel3 extends \Elementor\Widget_Base
{
    /**
     * testimonial_carousel3 constructor.
     * @param array $data
     * @param null $args
     */
    public function __construct($data = [], $args = null)
    {
        ...
        mw_assets::register_style('testimonial_carousel3_css', mw_assets::get_css('elementor.testimonial_carousel3'));
        ...
        mw_assets::register_script('testimonial_carousel3_js', mw_assets::get_js('elementor.testimonial_carousel3'));
    }

    public function get_style_depends()
    {
        return [mw_assets::get_handle_name('testimonial_carousel3_css'), mw_assets::get_handle_name('swipercss')];
    }

    public function get_script_depends()
    {
        return [mw_assets::get_handle_name('swiperjs'), mw_assets::get_handle_name('testimonial_carousel3_js')];
    }
    ...
    {
        return esc_html__('Testimonial Carousel 3', 'ahura');
    }
    ...
    {
        return ['testimonialcarousel3', 'testimonial_carousel3', esc_html__('Testimonial Carousel 3', 'ahura')];
    }
    ...
    public function register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .testimonial-item-content' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
                'default' => [
                        'unit' => 'px',
                        'top' => 10,
    ...
    public function render()
    {
        ...
        ?>
        <div class="testimonial-carousel testimonial-carousel-3<?php echo $has_paginate ? ' has-paginate-' . $settings['pagination'] : '' ?><?php echo $has_navigate ? ' has-navigate' : '' ?>">
            <div class="swiper testimonial-carousel-3-<?php echo $wid; ?>">
                    ...
                    <div class="testimonial-carousel-item-wrap">
                        <div class="ahura-testimonial testimonial-carousel-item">
                            <div class="testimonial-item-content">
                                <?php if($avatar_url): ?>
                                <div class="cover">
                                    <div class="avatar" style="background-image: url('<?php echo $avatar_url; ?>')"></div>
                ...
                <script type="text/javascript">
                    jQuery(document).ready(function($){
                        handleTestimonialCarousel3Element({
