...
class image_slider3 extends \Elementor\Widget_Base
{
    ...
    public function __construct($data = [], $args = null)
    {
        ...
        mw_assets::register_script('image_slider3_js', mw_assets::get_js('elementor.image_slider3'), false);
    }
    ...
    {
        return [mw_assets::get_handle_name('swiperjs'), mw_assets::get_handle_name('image_slider3_js')];
    }
    ...
    public function register_controls()
    {
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .image-slider-3 img' => 'border-radius: {{SIZE}}{{UNIT}};'
                ]
            ]
        );
