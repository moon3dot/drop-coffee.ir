...
class products_category2 extends \Elementor\Widget_Base
{
    ...
    public function __construct($data = [], $args = null)
    {
        ...
        mw_assets::register_style('products_category2_css', mw_assets::get_css('elementor.products_category2'));
    ...
    {
        $styles = [mw_assets::get_handle_name('products_category2_css'), mw_assets::get_handle_name('swipercss')];
        return $styles;
    }

    public function get_script_depends()
    {
        return [mw_assets::get_handle_name('swiperjs'), mw_assets::get_handle_name('products_category2_js')];
    }
    /**
     *
     * Set element id
    ...
    {
        return ['productscategory2', 'products_category2', esc_html__('Product Categories Carousel 2', 'ahura')];
    }
    ...
    public function render()
    {
        ...
        if(!$cats)
            return false;
        ?>
       <div class="ahura-products-category2 ahura-products-category2-<?php echo $wid; ?><?php echo $has_navigate ? ' has-navigate' : '' ?>">
        <div class="swiper ahura-products-category2-carousel ahura-products-category2-carousel-<?php echo $wid; ?>">
        ...
        <script type="text/javascript">
            jQuery(document).ready(function($){
                handleProductsCategory2Element({
