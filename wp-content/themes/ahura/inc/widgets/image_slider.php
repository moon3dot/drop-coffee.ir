...
class image_slider extends \Elementor\Widget_Base
{
    use \ahura\app\traits\link_utilities;

    /**
     * image_slider constructor.
     * @param array $data
     * @param null $args
     */
    public function __construct($data = [], $args = null)
    {
        ...
        mw_assets::register_style('image_slider_css', mw_assets::get_css('elementor.image_slider'));
        ...
        mw_assets::register_script('image_slider_js', mw_assets::get_js('elementor.image_slider'), false);
    }

    public function get_style_depends()
    {
        $styles = [mw_assets::get_handle_name('swipercss'), mw_assets::get_handle_name('image_slider_css')];
        return $styles;
    }

    public function get_script_depends()
    {
        return [mw_assets::get_handle_name('swiperjs'), mw_assets::get_handle_name('image_slider_js')];
    }
    ...
    {
        return esc_html__('Image Slider', 'ahura');
    }
    ...
    {
        return ['imageslider', 'image_slider', esc_html__('Image Slider', 'ahura')];
    }
    ...
    public function register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '#000',
                'selectors' => [
                    '{{WRAPPER}} .image-slider-1 .swiper-nav-button i' => 'border-bottom-color: {{VALUE}}',
                    '{{WRAPPER}} .image-slider-1 .swiper-btn-prev i:after' => 'border-top-color: {{VALUE}};border-right-color: {{VALUE}}',
                    '{{WRAPPER}} .image-slider-1 .swiper-btn-next i:after' => 'border-bottom-color: {{VALUE}};border-left-color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '#00000087',
                'selectors' => [
                    '{{WRAPPER}} .image-slider-1 .swiper-pagination-bullets .swiper-pagination-bullet' => 'background: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '#000',
                'selectors' => [
                    '{{WRAPPER}} .image-slider-1 .swiper-pagination-bullets .swiper-pagination-bullet-active' => 'background: {{VALUE}}',
                    '{{WRAPPER}} .image-slider-1 .swiper-pagination-bullets .swiper-pagination-bullet-active:before' => 'background-color: {{VALUE}}',
                ],
            ]
        );
        $this->end_controls_section();
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .image-slider-1, {{WRAPPER}} .image-slider-1 img' => 'border-radius: {{SIZE}}{{UNIT}};'
                ]
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .image-slider-1',
            ]
        );
    ...
    public function render()
    {
        ...
        ?>
        <div class="image-slider-1 image-slider-1-<?php echo $wid; ?><?php echo $has_paginate ? ' has-paginate' : '' ?><?php echo $has_navigate ? ' has-navigate' : '' ?>">
