...
class testimonial_carousel extends \Elementor\Widget_Base
{
    ...
    public function __construct($data = [], $args = null)
    {
        ...
        mw_assets::register_script('testimonial_carousel_js', mw_assets::get_js('elementor.testimonial_carousel'));
    }
    ...
    {
        return [mw_assets::get_handle_name('swiperjs'), mw_assets::get_handle_name('testimonial_carousel_js')];
    }
            ...
            <div class="swiper testimonial-carousel-1-<?php echo $wid; ?>">
                ...
                <script type="text/javascript">
                    jQuery(document).ready(function($){
                        handleTestimonialCarouselElement({
