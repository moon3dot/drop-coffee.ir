...
?>
<form class="woocommerce-form woocommerce-form-login login" method="post" <?php echo isset($hidden) ? 'style="display:none;"' : ''; ?> action="<?php echo get_permalink( wc_get_page_id( 'myaccount' ) ); ?>">
